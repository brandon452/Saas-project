...
EXPORT_CSV_SERVICE_ENABLED = os.getenv("EXPORT_CSV_SERVICE_ENABLED", "false").lower() == "true"
EXPORT_CSV_SERVICE_ENDPOINT_OVERRIDES = os.getenv("EXPORT_CSV_SERVICE_ENDPOINT_OVERRIDES", "{}")
